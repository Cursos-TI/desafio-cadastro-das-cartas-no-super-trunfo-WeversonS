...
printf("Insira uma Letra para Cada Carta e Um Codigo para Cada Cidade \n");
...
printf("Quem Vence em População?\n");
if (populacao1 > populacao2){
    printf(" %s Venceu!\n", nomedacidade);
}else{
    printf(" %s Venceu!\n", nomedacidade2);
}
printf("Quem Vence em Area?\n");
if (area1 > area2){
    printf(" %s Venceu!\n", nomedacidade);
}else{
    printf(" %s Venceu!\n", nomedacidade2);
}
printf("Quem Vence em PIB?\n");
if (PIB1 > PIB2){
    printf(" %s Venceu!\n", nomedacidade);
}else{
    printf(" %s Venceu!\n", nomedacidade2);
}
printf("Quem Vence em Densidade Populacional?\n");
if (densidadepopulacional1 < densidadepopulacional2){
    printf(" %s Venceu!\n", nomedacidade);
}else{
    printf(" %s Venceu!\n", nomedacidade2);
}
printf("Quem Vence em Pib per capta?\n");
